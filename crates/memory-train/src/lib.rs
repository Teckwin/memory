...
async fn test_complete_training_flow() {
    ...
    let memories = vec![
        MemoryEntry::new(
            Uuid::new_v4(),
            memory_core::MemoryContent::Text("Sample text 1 for training".to_string()),
            MemoryMetadata::new(memory_core::MemorySource::System {
                source_type: "test".to_string(),
            }),
        ),
        MemoryEntry::new(
            Uuid::new_v4(),
            memory_core::MemoryContent::Text("Sample text 2 for training".to_string()),
            MemoryMetadata::new(memory_core::MemorySource::System {
                source_type: "test".to_string(),
            }),
        ),
    ...
    for i in 3..20 {
        all_memories.push(MemoryEntry::new(
            Uuid::new_v4(),
            memory_core::MemoryContent::Text(format!("Sample text {} for training", i)),
            MemoryMetadata::new(memory_core::MemorySource::System {
                source_type: "test".to_string(),
            }),
        ));
